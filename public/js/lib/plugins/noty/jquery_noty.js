...
// yash : converting it into require js module
...
define(["jQuery"], function(jQ) {
	...
	noty = function (options) {
		...
		if (!options.closeWith) {
			options.closeWith = jQ.noty.defaults.closeWith;
		}
		...
		if (options.buttons) {
			jQ.each(options.buttons, function(i, button) {
				if (button.click) {
					using_old++;
		...
		return jQ.notyRenderer.init(options);
	}
